...
<head>
    ...
    <body onload="onload_ajax_rent()">
       <div  role="navigation" >
  　 <div class="navbar-header">
       <a href="##" class="navbar-brand">器材租用</a>
  ...
  <div >
         <form id="form" name="users_equi/rent_query" method="post" style="padding-top: 70px">
  			<table class="table text-nowrap table-hover " id="rent_tb">
				<tr id="rent_tr">
...
<script type="text/javascript" charset="UTF-8" src="../js/rent.js"></script> 
</html>