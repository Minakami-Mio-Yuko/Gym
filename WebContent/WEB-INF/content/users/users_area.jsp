...
<body>
	...
	<ul class="nav navbar-nav">
		...
		<li class="li_area clicked"><a href="users_area">场地相关</a></li>
	...
	<div class="row">
		<div class="col-md-2 text-center center-block">
			<ul class="verticalnav">
				<li><a href="users_area/a">场地管理11</a></li>
				<li><a href="users_area/b">场地管理22</a></li>
				<li><a href="users_area/c">场地管理33</a></li>
			</ul>
		</div>
