	...
	<div class="row">
		<div class="col-md-2 text-center center-block">
			<ul class="verticalnav">
				...
				<li><a href="../users_user/info" class="current">个人信息</a></li>
		...
		<div class="col-md-10  center-block">
			...
			<table class="table table-striped table-bordered">
				...
				<tr>
					<td>班级</td>
					<td><%=s.getAttribute("userClass")%></td>
				</tr>
				<tr>
					<td>性别</td>
					<td><%=s.getAttribute("userSex")%></td>
				</tr>
				<tr>
					<td>籍贯</td>
					<td><%=s.getAttribute("userHome")%></td>
				</tr>
			</table>
		</div>
	</div>
