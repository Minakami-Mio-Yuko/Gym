...
<body>
	...
	<ul class="nav navbar-nav">
		...
		<li class="li_area clicked"><a href="../admin_area">场地管理</a></li>
	...
	<div class="row">
		<div class="col-md-2 text-center center-block">
			<ul class="verticalnav">
			    <li><a href="../admin_area/a">场地管理1</a></li>
				<li><a href="../admin_area/b" class="current">场地管理2</a></li>
				<li><a href="../admin_area/c">场地管理3</a></li>
			</ul>
		</div>
