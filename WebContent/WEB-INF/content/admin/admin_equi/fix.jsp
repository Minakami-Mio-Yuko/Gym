	...
	<div class="row">
		<div class="col-md-2 text-center center-block">
			<ul class="verticalnav">
				...
				<li><a href="../admin_equi/delete">器材删除</a></li>
				<li><a href="../admin_equi/change">器材修改</a></li>
				<li><a href="../admin_equi/find">器材查询</a></li>
				<li><a href="../admin_equi/fix" class="current">器材维护</a></li>
			</ul>
		</div>
		<div class="col-md-10  center-block"><jsp:include page="../../equipment/maintenance/maintenance.jsp"/>
		</div>
	</div>
</body>
