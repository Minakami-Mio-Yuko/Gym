...
<title>场地管理模块</title>
	...
	<body style="background: #E6E6FA;">
		...
		<div class="container" style="background: white;">
			<form action="${pageContext.request.contextPath}/Admin/likequery">
			<div class="row">				
				<div class="col-md-4" align="center">
					<span style="font-family: "黑体";">位置:</span>
					&nbsp;
				...
				<div class="col-md-2" align="center">
				<a href="${pageContext.request.contextPath}/Admin/newone"  class="btn btn-primary" role="button" >新建</a> 				
				</div>
				...
				<div class="row">
					...
					<c:forEach var="detail" items="${list}">	
						<tr>
							...
							<td align="center"><p><a href="${pageContext.request.contextPath}/Admin/edit?id=${detail.siteId}" class="btn btn-sm btn-primary" role="button" >修改</a> <a href="${pageContext.request.contextPath}/Admin/delete?id=${detail.siteId}" class="btn btn-sm btn-primary" >删除</a></p></td>
						</tr>
						</c:forEach>
					</table>
					</div>				
